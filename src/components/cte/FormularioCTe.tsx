        ...
        <div className="flex items-center gap-4 mb-6">
          {[1, 2, 3, 4].map((etapa) => (
            <div key={etapa} className="flex items-center gap-2">
              ...
              <span
                className={`text-sm ${etapa <= etapaAtual ? "text-blue-600" : "text-gray-500"}`}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Select
              ...
              options={[
                ...
                {
                  value: "proprio_destinatario",
                  label: "Próprio Destinatário",
                },
              ]}
              required
            />
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("pedagios", parseFloat(e.target.value) || 0)
              }
              placeholder="0,00"
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {dados.modal === "aquaviario" && (
              <Input
                ...
                value={dados.cubagem || ""}
                onChange={(e) =>
                  handleInputChange("cubagem", parseFloat(e.target.value) || 0)
                }
                placeholder="0,000"
              />
            )}
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("quantidade", parseInt(e.target.value) || 1)
              }
              placeholder="1"
              required
            />
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("valorCarga", parseFloat(e.target.value) || 0)
              }
              placeholder="0,00"
              required
            />
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("valorFrete", parseFloat(e.target.value) || 0)
              }
              placeholder="0,00"
              required
            />
