        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Sistema completo de emissão fiscal 2025/2026
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <FormGroup label="Natureza da Operação" required>
              ...
              >
                ...
                <option value="Remessa para Demonstração">
            ...
            <FormGroup label="Série" required>
              <Input
                value={dados.serie}
                onChange={(e) =>
                  setDados((prev) => ({ ...prev, serie: e.target.value }))
                }
                placeholder="1"
              />
            </FormGroup>
            ...
            <FormGroup label="Finalidade" required>
              <Select
                ...
                onChange={(e) =>
                  setDados((prev) => ({ ...prev, finalidade: e.target.value }))
                }
              >
            ...
            >
              ...
              >
                ...
                <option value="substituicao_tributaria">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FormGroup label="Modalidade do Frete">
              ...
              >
                ...
                <option value="Por conta do Emitente">
                  1 - Por conta do Emitente
                </option>
                <option value="Por conta do Destinatário">
                  2 - Por conta do Destinatário
                </option>
                <option value="Por conta de Terceiros">
                  3 - Por conta de Terceiros
                </option>
                <option value="Transporte Próprio por conta do Destinatário">
                  4 - Transporte Próprio por conta do Destinatário
                </option>
                <option value="Sem Ocorrência de Transporte">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FormGroup label="Forma de Pagamento">
              ...
              >
                ...
                <option value="Duplicata Mercantil">
        ...
        <CardBody>
          <FormGroup label="Informações Complementares">
            ...
            <div className="text-xs text-gray-500 mt-2">
              As observações legais são geradas automaticamente baseadas no
              regime tributário selecionado. Você pode adicionar informações
