...
export const CFOP_OPTIONS = [
  ...
  { value: '5103', label: '5103 - Venda de produção do estabelecimento (sem transitar)' },
  { value: '5104', label: '5104 - Venda de mercadoria de terceiros (sem transitar)' },
  { value: '5116', label: '5116 - Venda produção encomenda entrega futura' },
  { value: '5117', label: '5117 - Venda mercadoria terceiros encomenda entrega futura' },
  ...
  { value: '6103', label: '6103 - Venda produção sem transitar (interestadual)' },
  { value: '6104', label: '6104 - Venda de mercadoria de terceiros sem transitar (interestadual)' },
  { value: '5933', label: '5933 - Prestação de serviço sujeito ao ICMS' },
  { value: '6933', label: '6933 - Prestação de serviço sujeito ao ICMS (interestadual)' }
];
...
export const CST_PIS_OPTIONS = [
  { value: '01', label: '01 - Operação tributável (alíquota normal cumulativa/não cumulativa)' },
