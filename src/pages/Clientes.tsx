...
const Clientes: React.FC = () => {
  ...
  const carregarClientes = async () => {
    try {
      ...
      showToast(
        err?.response?.data?.message || "Erro ao listar clientes",
        "error",
      );
    } finally {
      setLoading(false);
  ...
  const clientesFiltrados = useMemo(() => {
    return clientes.filter((c) => {
      ...
      const ativoOk =
        filtroAtivo === "todos" ||
        (filtroAtivo === "ativo" ? c.ativo : !c.ativo);
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormGroup
                  label={novoCliente.tipo === "cpf" ? "CPF" : "CNPJ"}
                  required
                >
                  <Input
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormGroup
                  label={selecionado.tipo === "cpf" ? "CPF" : "CNPJ"}
                  required
                >
                  <Input
                    value={selecionado.documento}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        documento: e.target.value,
                ...
                {selecionado.tipo === "cnpj" && (
                  <>
                    ...
                    <FormGroup label="Nome Fantasia">
                      <Input
                        value={selecionado.nomeFantasia || ""}
                        onChange={(e) =>
                          setSelecionado({
                            ...selecionado!,
                            nomeFantasia: e.target.value,
                    ...
                    <FormGroup label="Inscrição Estadual">
                      <Input
                        value={selecionado.inscricaoEstadual || ""}
                        onChange={(e) =>
                          setSelecionado({
                            ...selecionado!,
                            inscricaoEstadual: e.target.value,
                ...
                <FormGroup label="CEP">
                  <Input
                    value={selecionado.endereco?.cep || ""}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        endereco: {
                ...
                <FormGroup label="Logradouro">
                  <Input
                    value={selecionado.endereco?.logradouro || ""}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        endereco: {
                ...
                <FormGroup label="Número">
                  <Input
                    value={selecionado.endereco?.numero || ""}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        endereco: {
                ...
                <FormGroup label="Complemento">
                  <Input
                    value={selecionado.endereco?.complemento || ""}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        endereco: {
                ...
                <FormGroup label="Bairro">
                  <Input
                    value={selecionado.endereco?.bairro || ""}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        endereco: {
                ...
                <FormGroup label="Cidade">
                  <Input
                    value={selecionado.endereco?.cidade || ""}
                    onChange={(e) =>
                      setSelecionado({
                        ...selecionado!,
                        endereco: {
