...
export function GestaoEventos() {
  const [abaAtiva, setAbaAtiva] = useState<
    "documentos" | "eventos" | "novo-evento"
  >("documentos");
  const [filtroTipo, setFiltroTipo] = useState<
    "todos" | "NFe" | "CTe" | "MDFe"
  >("todos");
  const [filtroStatus, setFiltroStatus] = useState<
    "todos" | "Autorizado" | "Cancelado" | "Inutilizado"
  >("todos");
  const [busca, setBusca] = useState("");
  const [documentoSelecionado, setDocumentoSelecionado] =
    useState<Documento | null>(null);
  const [tipoEvento, setTipoEvento] = useState<
    "cancelamento" | "carta-correcao" | "inutilizacao"
  >("cancelamento");
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2 ml-4">
                ...
                {documento.podeEventos.cartaCorrecao && (
                  <button
                    onClick={() =>
                      handleNovoEvento(documento, "carta-correcao")
                    }
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div>
              ...
              <div className="font-medium">
                {documentoSelecionado.numero}/{documentoSelecionado.serie}
              </div>
            </div>
            <div>
              <span className="text-gray-600">Destinatário:</span>
              <div className="font-medium">
                {documentoSelecionado.destinatario}
              </div>
            </div>
          </div>
        </Card>
              ...
              <div className="p-4 bg-yellow-50 rounded-lg">
                <div className="flex items-center gap-2 text-yellow-800 mb-2">
                  ...
                  <span className="font-medium">
                    Atenção - Prazos para Cancelamento
                  </span>
                </div>
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>
                    • NFe: 24 horas após autorização (alguns estados permitem
                    até 168h)
                  </li>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                  ...
                  <option value="dados_destinatario">
                    Dados do Destinatário
                  </option>
                  <option value="informacoes_complementares">
                    Informações Complementares
                  </option>
                  <option value="dados_produto">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-700">
                  A inutilização é utilizada quando há falhas na sequência
                  numérica dos documentos fiscais. Deve ser feita antes da
                  emissão do próximo documento.
                </p>
              </div>
