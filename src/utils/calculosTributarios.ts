...
const ALIQUOTAS_SIMPLES: Record<string, number[]> = {
  I: [
    4.0, 7.3, 9.5, 10.7, 11.2, 11.7, 12.2, 12.7, 13.2, 13.7, 14.2, 14.7, 15.2,
    15.7, 16.2, 16.7, 17.2, 17.7, 18.2, 18.7,
  ],
  II: [
    4.5, 7.8, 10.0, 11.2, 11.7, 12.2, 12.7, 13.2, 13.7, 14.2, 14.7, 15.2, 15.7,
    16.2, 16.7, 17.2, 17.7, 18.2, 18.7, 19.2,
  ],
  III: [
    6.0, 11.2, 13.5, 16.0, 21.0, 21.0, 21.0, 21.0, 21.0, 21.0, 21.0, 21.0, 21.0,
    21.0, 21.0, 21.0, 21.0, 21.0, 21.0, 21.0,
  ],
  IV: [
    4.5, 9.0, 10.2, 14.0, 22.0, 22.0, 22.0, 22.0, 22.0, 22.0, 22.0, 22.0, 22.0,
...
export function calcular2026(
  ...
  const isValor = ncm.startsWith("2402")
    ? (valorTotal * ALIQUOTAS_2026.IS) / 100
    : 0;
...
export function gerarObservacoesLegais(regime: RegimeTributario): string {
  ...
  return Array.isArray(observacoes)
    ? observacoes.join("\n")
